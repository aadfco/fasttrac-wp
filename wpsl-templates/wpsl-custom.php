...
$output .= "\t\t\t" . '<div class="wpsl-input cell small-6">' . "\r\n";
...
if ( $wpsl_settings['radius_dropdown'] || $wpsl_settings['results_dropdown']  ) {
    ...
    if ( $wpsl_settings['radius_dropdown'] ) {
        $output .= "\t\t\t\t" . '<div id="wpsl-radius cell auto">' . "\r\n";
    ...
    if ( $wpsl_settings['results_dropdown'] ) {
        $output .= "\t\t\t\t" . '<div id="wpsl-results cell auto">' . "\r\n";
...
$output .= "\t\t\t\t" . '<div class="wpsl-search-btn-wrap"><input id="wpsl-search-btn" class="button" type="submit" value="' . esc_attr( $wpsl->i18n->get_translation( 'search_btn_label', __( 'Search', 'wpsl' ) ) ) . '"></div>' . "\r\n";

$output .= "\t\t" . '</form>' . "\r\n"; // End form
$output .= "\t\t" . '</div>' . "\r\n"; // End #wpsl-search-wrap
$output .= "\t" . '</div>' . "\r\n"; // End inner-row
